## Contents 
 ...
 - [Cross Site Scripting (XSS)](https://github.com/justforhackz/Awesome-Bugbounty-Writeups#cross-site-scripting-xss)
 - [Cross Site Request Forgery (CSRF)](https://github.com/justforhackz/Awesome-Bugbounty-Writeups#cross-site-request-forgery-csrf)
 - [Clickjacking (UI Redressing Attack)](https://github.com/justforhackz/Awesome-Bugbounty-Writeups#clickjacking-ui-redressing-attack)
 - [Local File Inclusion (LFI)](https://github.com/justforhackz/Awesome-Bugbounty-Writeups#local-file-inclusion-lfi)
 - [Subdomain Takeover](https://github.com/justforhackz/Awesome-Bugbounty-Writeups#subdomain-takeover)
 - [Denial of Service (DOS)](https://github.com/justforhackz/Awesome-Bugbounty-Writeups#denial-of-service-dos)
 - [Authentication Bypass](https://github.com/justforhackz/Awesome-Bugbounty-Writeups#authentication-bypass)
 - [SQL injection](https://github.com/justforhackz/Awesome-Bugbounty-Writeups#sql-injectionsqli)
 - [Insecure Direct Object Reference (IDOR)](https://github.com/justforhackz/Awesome-Bugbounty-Writeups#insecure-direct-object-reference-idor)
 - [2FA Related issues](https://github.com/justforhackz/Awesome-Bugbounty-Writeups#2fa-related-issues) 
 - [CORS Related issues](https://github.com/justforhackz/Awesome-Bugbounty-Writeups#cors-related-issues)
 - [Server Side Request Forgery (SSRF)](https://github.com/justforhackz/Awesome-Bugbounty-Writeups/blob/master/README.md#server-side-request-forgery-ssrf)
 - [Race Condition](https://github.com/justforhackz/Awesome-Bugbounty-Writeups/blob/master/README.md#race-condition)
 - [Remote Code Execution (RCE)](https://github.com/justforhackz/Awesome-Bugbounty-Writeups#remote-code-execution-rce)
 - [Android Pentesting](https://github.com/justforhackz/Awesome-Bugbounty-Writeups#android-pentesting) 
 - [Contributing](https://github.com/justforhackz/Awesome-Bugbounty-Writeups#contributing)
 - [Maintainers](https://github.com/justforhackz/Awesome-Bugbounty-Writeups#maintainers)
